      ...
      <div className="glass-panel p-5 rounded-2xl flex flex-col md:flex-row items-start md:items-center justify-between gap-4 border-l-4 border-l-indigo-500">
        ...
        <div className="flex items-center gap-3 w-full md:w-auto justify-end">
          <button
            ...
            className="flex items-center gap-2 px-3.5 py-2 rounded-xl bg-sky-950/80 hover:bg-sky-900 border border-sky-500/40 text-sky-300 text-sm font-bold transition shadow-sm"
